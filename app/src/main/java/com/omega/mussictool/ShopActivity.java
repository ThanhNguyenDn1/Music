...
public class ShopActivity extends AppCompatActivity implements PurchasesUpdatedListener {
    ...
    private static final String SUB4 = BillingClientSetup.ITEM_BUY_SUB_4;
    private static final String SUB5 = BillingClientSetup.ITEM_BUY_SUB_5;
    private static final String SUcB1 = BillingClientSetup.ITEM_BUY_SUB_1;
    private static final String ScdUB2 = BillingClientSetup.ITEM_BUY_SUB_2;
    private static final String dfSUB3 = BillingClientSetup.ITEM_BUY_SUB_3;
    private static final String gergSUB4 = BillingClientSetup.ITEM_BUY_SUB_4;
    private static final String SqwdewUB5 = BillingClientSetup.ITEM_BUY_SUB_5;
    ...
    private static final String INAPP4 = BillingClientSetup.ITEM_BUY_INAPP_4;
    private static final String INAPP5 = BillingClientSetup.ITEM_BUY_INAPP_5;
    ...
    private void handleEvents() {
        ...
        findViewById(R.id.btnSub4).setOnClickListener(view -> launchBillingSub(SUB4));
        findViewById(R.id.btnSub5).setOnClickListener(view -> launchBillingSub(SUB5));
        ...
        findViewById(R.id.btnInApp4).setOnClickListener(view -> launchBillingInApp(INAPP4));
        findViewById(R.id.btnInApp5).setOnClickListener(view -> launchBillingInApp(INAPP5));
